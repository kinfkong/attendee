...
COMPONENT_NAME="EventNotification"
COMPONENT_H_NAME="event notification"
COMPONENT_URL="eventNotifications"
COMPONENT_VAR_NAME="eventNotification"

GENERATE_TARGET_DIR=./microservice2/src/main/java/com/
